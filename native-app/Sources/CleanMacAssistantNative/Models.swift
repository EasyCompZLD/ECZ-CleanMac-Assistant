...
enum MaintenanceCatalog {
    ...
    static let tasks: [MaintenanceTaskDefinition] = [
        ...
        MaintenanceTaskDefinition(
            ...
            subtitle: "Scan the system recursively with ClamAV and a local signatures database.",
            detail: "A deeper security task that can take a long time. The first run may refresh the ClamAV signatures in your user Library before the actual malware sweep starts.",
